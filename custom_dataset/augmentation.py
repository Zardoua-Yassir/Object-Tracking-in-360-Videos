...
from utils.bbox import corner2center, Center, center2corner, Corner
...
class Augmentation:
    ...
    @staticmethod
    def random():
        return np.random.random() * 2 - 1.0  # # will generate a value in the range [-1, 1]
    ...
    def _shift_scale_aug(self, image, bbox, crop_bbox, size):
        ...
        # adjust window bounding box
        crop_bbox_center = corner2center(crop_bbox)  # # converts to x_boxcenter, y_boxcenter, w, h
        if self.scale:
