...
class LogScheduler(PysotLRScheduler):
...
class StepScheduler(PysotLRScheduler):
...
class MultiStepScheduler(PysotLRScheduler):
    def __init__(self, optimizer, start_lr=0.01, end_lr=None,
...
class LinearStepScheduler(PysotLRScheduler):
...
class CosStepScheduler(PysotLRScheduler):
    def __init__(self, optimizer, start_lr=0.01, end_lr=0.005,
                 epochs=50, last_epoch=-1, **kwargs):
        self.start_lr = start_lr
        self.end_lr = end_lr
...
class WarmUPScheduler(PysotLRScheduler):
